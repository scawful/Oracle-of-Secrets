...
- **UNBLOCKED** — author expanded text through
  `Data/dialogue/expanded_messages.json` and regenerate
  `Core/Generated/expanded_messages.asm`; direct ROM writes are not durable
