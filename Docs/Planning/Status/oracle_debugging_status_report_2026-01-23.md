...
- Water collision fix (Jan 21) is applied and room-load hook re-enabled, but persistence verification is still pending; prior test notes (Jan 22) show only partial swim coverage and water persistence not retested. (Docs/Debugging/Testing/oos168x_test_status.md)
