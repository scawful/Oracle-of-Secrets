...
- Build + reload + validation: `Scripts/Build/oos-verify.sh`
- Underlying build loop: `Scripts/Build/dev_loop.sh 168 --mesen-sync --reload`
...
- YAZE GUI / z3ed workflows:
  - Use the installed `z3ed` command for CLI validation and safe-edit workflows.
