...
For a more detailed breakdown of the ROM map, refer to the `ZS ROM MAP.txt` file in the `Core/` directory, and `Docs/Technical/MemoryMap.md` for a comprehensive overview of all custom memory regions.
...
*   **`Docs/Technical/MemoryMap.md`:** A comprehensive map of all custom WRAM and SRAM variables, including repurposed vanilla blocks. See [MemoryMap.md](../../Technical/MemoryMap.md) for details.

*   **`Docs/Technical/Ram.md`:** High-level overview of WRAM and SRAM usage with verified custom variables. See [Ram.md](../../Technical/Ram.md) for details.
...
*   **`Docs/World/Guides/QuestFlow.md`:** A detailed guide to the main story and side-quest progression, including trigger conditions and progression flags. See [QuestFlow.md](../../World/Guides/QuestFlow.md) for details.

*   **`Docs/World/Guides/SpriteCreationGuide.md`:** A step-by-step tutorial for creating a new custom sprite using the project's frameworks and conventions. See [SpriteCreationGuide.md](../../World/Guides/SpriteCreationGuide.md) for details.

*   **`Docs/World/Features/Menu/Menu.md`:** A detailed analysis of the custom menu and HUD systems. See [Menu.md](../../World/Features/Menu/Menu.md) for details.

*   **`Docs/World/Features/Items/Items.md`:** A detailed guide to the custom and modified items in the game. See [Items.md](../../World/Features/Items/Items.md) for details.

*   **`Docs/World/Features/Music/Music.md`:** A guide to the custom music tracks and sound effects, including how to add new audio. See [Music.md](../../World/Features/Music/Music.md) for details.

*   **`Docs/World/Features/Masks/Masks.md`:** A comprehensive overview of the Mask System, including each mask's abilities and implementation details. See [Masks.md](../../World/Features/Masks/Masks.md) for details.

*   **`Docs/World/Dungeons/Dungeons.md`:** A breakdown of all dungeons, including layouts, enemy placements, and puzzle solutions. See [Dungeons.md](../../World/Dungeons/Dungeons.md) for details.

*   **`Docs/World/Overworld/Overworld.md`:** An analysis of the overworld systems, including `ZSCustomOverworld`, the time system, and other custom features. See [Overworld.md](../../World/Overworld/Overworld.md) for details.

*   **`Docs/World/Sprites/NPCs.md`:** An analysis of the various NPC sprites. See [NPCs.md](../../World/Sprites/NPCs.md) for details.

*   **`Docs/World/Sprites/Bosses.md`:** An analysis of the custom boss sprites. See [Bosses.md](../../World/Sprites/Bosses.md) for details.

*   **`Docs/World/Sprites/Objects.md`:** An analysis of interactive object sprites. See [Objects.md](../../World/Sprites/Objects.md) for details.

*   **`Docs/World/Sprites/Overlord.md`:** An analysis of the Overlord sprite system. See [Overlord.md](../../World/Sprites/Overlord.md) for details.
