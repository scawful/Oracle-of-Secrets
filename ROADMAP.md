...
- Finish a full content release in 2026 (see `Docs/Plans/release_2026_definition.md`).
...
2. **Goron Mines (minecart) expansion**
   ...
   - Prefer incremental track slots and room-by-room activation: see `Docs/Plans/goron_mines_minecart_design.md`.
...
3. **Progression infrastructure**
   ...
   - Spec: `Docs/Plans/progression_infrastructure.md`.
...
See `Docs/Tooling/Z3DK_Analyzer_Findings.md` and `Docs/Tooling/Z3ASM_Feature_Ideas.md`.

### Debug + tests
- Treat `Docs/STABILITY.md` as “stop-ship gotchas” (color math, SPC timeouts, input hygiene).
- Grow the canon savestate library and keep transition tests deterministic (see `Docs/Tooling/Debugging_Infrastructure_Roadmap.md`).

## Sources of Truth
- Backlog + epics: `oracle.org`
- Release definition: `Docs/Plans/release_2026_definition.md`
- Dungeon plans: `Docs/Plans/`
- Tooling plans/findings: `Docs/Tooling/`
