...
; =========================================================
; Dialogue Bundle Import — expanded messages $1D2–$1F9
; Source bundles live in Data/dialogue/*.json.
; Keep IDs bank-local in bundle JSON, then mirror durable changes here.
; NOTE: z3ed --apply writes binary ROM output and is not durable across
;       build_rom.sh rebuilds unless ASM source is updated.
; =========================================================

; --- Gossip Stones (3 slots: $1D2–$1D4) ---
Message_1D2:  ; TODO(gossip): Gossip Stone 1 — author via message editor
  db $41, $41, $41, $7F

Message_1D3:  ; TODO(gossip): Gossip Stone 2 — author via message editor
  db $41, $41, $41, $7F

Message_1D4:  ; TODO(gossip): Gossip Stone 3 — author via message editor
  db $41, $41, $41, $7F

; --- Windmill Guy — Song of Storms quest ---
Message_1D5:
...
; --- Reserved gap ($1D9–$1DF, 7 slots for future use) ---
Message_1D9:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DA:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DB:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DC:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DD:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DE:  ; RESERVED
  db $41, $41, $41, $7F

Message_1DF:  ; RESERVED
  db $41, $41, $41, $7F

; --- Goron Elder — D6 Goron Mines lore ---
Message_1E0:
...
; --- River Zora Elder — Zora reconciliation ---
Message_1E5:
...
; --- Cartographer — Secret Shells side quest ---
Message_1EB:
